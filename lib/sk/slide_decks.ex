defmodule Sk.SlideDecks do
  @moduledoc """
  The SlideDecks context.
  """
  ...
  ## Examples
      ...
      %Ecto.Changeset{data: %SlideImage{}}

  """
  def change_slide_image(%SlideImage{} = slide_image, attrs \\ %{}) do
    SlideImage.changeset(slide_image, attrs)
  end
end
